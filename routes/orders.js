...
const { couponGet, postCoupon, removeCoupon, postCheckout, success, orders, singleOrder, adminOrders, downloadInvoice, verifyPayment } = require("../controller/ordersController");
